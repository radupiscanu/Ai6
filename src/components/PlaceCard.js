...
function PlaceCard(props) {
  ...
  return (
    <Div100vh
      ref={containerRef}
      style={{ position: 'absolute', top: 0, left: 0, width: '100%', overflowY: 'hidden', background: 'black' }}
    >
        ...
        >
          ...
          >
            ...
            <Stack onClick={handleOpenMapView} direction="row" spacing={1}>
              <MapOutlined />
              <Typography fontFamily="Google Sans" fontWeight="300">
                {' '}
                Map View{' '}
              </Typography>
            </Stack>
            ...
            {photos && photos.length !== 0 ? (
                    ...
                    <Box width="100%" height="100%">
                      <Box width="100%" height="100%" position="absolute">
                        ...
                        <div
                          style={{
                            ...
                            height: '30%',
                            background:
                              'linear-gradient(180deg, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.2) 31.73%, rgba(255, 255, 255, 0) 68.15%)',
                            top: 0,
                            left: 0,
                          }}
                        ></div>
                      ...
                      >
                        <Stack direction="column" color="white" spacing={1.5} p={3}>
                          <Typography variant="h4" fontFamily="Google Sans" fontSize="24px" fontWeight="300">
                            {name && name}
                          </Typography>
              ...
              <SwiperSlide>
                <Box width="100%" height="100%">
                  ...
                  >
                    <Stack direction="column" color="white" spacing={1.5} p={3}>
                      <Typography variant="h4" fontFamily="Google Sans">
                        {name && name}
                      </Typography>
      ...
      <Stack width="100%" zIndex="1000" color="white" direction="column" position="absolute" bottom="5%">
